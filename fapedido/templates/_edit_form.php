...
<tr>
	...
	<div id="divvendedores_id">
		  <?php echo label_for('fapedido[vendedores_id]', __($labels['fapedido{vendedores_id}' ]), 'class="required" Style="text-align:left; width:50px"') ?>
		  <div class="content<?php if ($sf_request->hasError('fapedido{vendedores_id}')): ?> form-error<?php endif; ?>">
		  <?php if ($sf_request->hasError('fapedido{vendedores_id}')): ?>
		    <?php echo form_error('fapedido{vendedores_id}', array('class' => 'form-error-msg')) ?>
		  <?php endif; ?>

          <?php $value = object_select_tag($fapedido, 'getVendedoresId', array (
	  'related_class' => 'Vendedores',
	  'control_name' => 'fapedido[vendedores_id]',
	)); echo $value ? $value : '&nbsp;' ?>
