	...
	$(document).ready(function() {
		...
		$("#buscar").click(function(){
		    var anio = $("#anio").val();
		    var mes = $("#mes").val();
		    url = "graficacoberturaestimadames?anio="+anio+"&mes="+mes;
	...
	<div id="titulo_grafico">ESTADÍSTICA COBERTURA DE ESTIMADOS POR MES</div>
	...
	<table>
	    ...
	    <?php if (count($arr)>0){?>
	    <tr><td id="titulo_tb">LISTADO DE VENDEDORES CON MÁS Y MENOS FACTURACIÓN POR MES</td></tr>
	    <tr>
